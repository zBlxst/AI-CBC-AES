...
params_enc = Params(True, b"This Is My Secret PAAAAAAAASSWORD", b"This Is The Unpredictible IV", "main.py", "main.py.enc")
params_dec = Params(False, b"This Is My Secret PAAAAAAAASSWORD", b"This Is The Unpredictible IV", "main.py.enc", "2.main.py")
